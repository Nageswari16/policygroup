...
class PolicygroupsComponent {
    ...
    onInput(event, formcontrolname, fieldtype, label, required) {
        ...
        //
        if (((_c = this.policyGroupForm.controls) === null || _c === void 0 ? void 0 : _c['policygroupname'].value) ||
            ((_d = this.policyGroupForm.controls) === null || _d === void 0 ? void 0 : _d['description'].value)) {
            this.isButtonDisabled = false;
        }
        else {
            this.isButtonDisabled = true;
