...
class PolicygroupsComponent {
    constructor(fb, alertService, cdr, groupsService, _storeservice) {
        this.fb = fb;
        this.alertService = alertService;
        this.cdr = cdr;
...
PolicygroupsComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: PolicygroupsComponent, deps: [{ token: i1$1.FormBuilder }, { token: AlertService }, { token: i0.ChangeDetectorRef }, { token: RbacService }, { token: DataStoreService }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: PolicygroupsComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1$1.FormBuilder }, { type: AlertService }, { type: i0.ChangeDetectorRef }, { type: RbacService }, { type: DataStoreService }]; } });
