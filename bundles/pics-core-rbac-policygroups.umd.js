(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var PolicygroupsComponent = /** @class */ (function () {
        function PolicygroupsComponent(fb, alertService, cdr, groupsService, _storeservice) {
            this.fb = fb;
            this.alertService = alertService;
            this.cdr = cdr;
    ...
    PolicygroupsComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: PolicygroupsComponent, deps: [{ token: i1__namespace$1.FormBuilder }, { token: AlertService }, { token: i0__namespace.ChangeDetectorRef }, { token: RbacService }, { token: DataStoreService }], target: i0__namespace.ɵɵFactoryTarget.Component });
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: PolicygroupsComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i1__namespace$1.FormBuilder }, { type: AlertService }, { type: i0__namespace.ChangeDetectorRef }, { type: RbacService }, { type: DataStoreService }]; } });
